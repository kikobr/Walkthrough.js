...
var EventManager = function () {
	function EventManager() {
		var walkthrough = arguments.length <= 0 || arguments[0] === undefined ? false : arguments[0];
...
var Walkthrough = function () {
   ...
   **/
			if (this.walkthroughManager) {
				...
				if (_currentStep) {
					var _currentStepElement = document.querySelector(_currentStep.target);
					this.walkthroughManager.onStepElementLeave(_currentStepElement, _currentStep);
				}
   ...
   **/
			var prevPage = this.getPage('prev');
			if (prevPage) {
		...
		value: function getPage() {
			...
			try {
				for (var _iterator2 = this.pages.entries()[Symbol.iterator](), _step2; !(_iteratorNormalCompletion2 = (_step2 = _iterator2.next()).done); _iteratorNormalCompletion2 = true) {
					var _step2$value = _slicedToArray(_step2.value, 2);

					var index = _step2$value[0];
					var _page = _step2$value[1];

					if (_page.url == window.location.pathname) {
			...
			if (position == 'prev') page = prevPage;else if (position == 'current') page = currentPage;else if (position == 'next') page = nextPage;
			return page;
		}
	}, {
		key: 'getStep',
		value: function getStep() {
			...
			var currentStep = null,
			    ...
			    nextStep = null,
			    step = null;
			var steps = this.getPage().steps;
			var _iteratorNormalCompletion3 = true;
			var _didIteratorError3 = false;
			var _iteratorError3 = undefined;

			try {
				for (var _iterator3 = steps.entries()[Symbol.iterator](), _step3; !(_iteratorNormalCompletion3 = (_step3 = _iterator3.next()).done); _iteratorNormalCompletion3 = true) {
					var _step3$value = _slicedToArray(_step3.value, 2);

					var index = _step3$value[0];
					var _step4 = _step3$value[1];
   ...
   **/
		...
		key: 'finishPage',
		value: function finishPage() {
			var finishedPage = this.getPage();
...
var WalkthroughManager = function () {
	function WalkthroughManager() {
		...
		this.onStepElementEnter = args.onStepElementEnter || function (el, step) {
			el.classList.add(this.className);
		};
		this.onStepElementLeave = args.onStepElementLeave || function (el, step) {
			el.classList.remove(this.className);
		};
		this.onFinish = args.onFinish || function (walkthroughName) {};
		this.currentWalkthrough = new _Walkthrough2.default();
	...
	_createClass(WalkthroughManager, [{
		...
		value: function load() {
			...
			walkthroughs.forEach(function (walkthrough) {
				...
				try {
					for (var _iterator = walkthrough.pages[Symbol.iterator](), _step; !(_iteratorNormalCompletion = (_step = _iterator.next()).done); _iteratorNormalCompletion = true) {
						var page = _step.value;
				...
				_this.walkthroughs.push(walkthrough);
			});
		}
		...
		value: function render() {
			...
			document.querySelector('[data-walkthroughs] [data-index]').addEventListener('click', function (evt) {
				var walkthrough = _this2.walkthroughs[evt.target.getAttribute('data-index')];
				_this2.start(walkthrough);
			});
		}
	}, {
		key: 'start',
...
},{"./EventManager":1,"./Walkthrough":2}],4:[function(require,module,exports){
'use strict';
...
},{"./classes/WalkthroughManager":3,"./unique-selector/src/index":11}],5:[function(require,module,exports){
'use strict';
...
},{"./isElement":12}],9:[function(require,module,exports){
'use strict';
...
},{"./isElement":12}],10:[function(require,module,exports){
"use strict";
...
},{"./getAttributes":5,"./getClasses":6,"./getID":7,"./getNthChild":8,"./getParents":9,"./getTag":10,"./isUnique":13}],12:[function(require,module,exports){
'use strict';
